...
#ifndef UKIVE_GRAPHICS_MAC_GPU_METAL_GPU_CONTEXT_METAL_H_
#define UKIVE_GRAPHICS_MAC_GPU_METAL_GPU_CONTEXT_METAL_H_
...
#endif  // UKIVE_GRAPHICS_MAC_GPU_METAL_GPU_CONTEXT_METAL_H_