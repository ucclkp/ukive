...
namespace win {
    ...
    GPUDataFormat unmapFormat(DXGI_FORMAT format) {
        ...
        case DXGI_FORMAT_R32G32B32A32_UINT:
            return GPUDataFormat::R32G32B32A32_UINT;
        case DXGI_FORMAT_R32G32B32_FLOAT:
            return GPUDataFormat::R32G32B32_FLOAT;
        case DXGI_FORMAT_R32G32B32_UINT:
            return GPUDataFormat::R32G32B32_UINT;
        case DXGI_FORMAT_R32G32_FLOAT:
            return GPUDataFormat::R32G32_FLOAT;
        case DXGI_FORMAT_R16G16B16A16_FLOAT:
            return GPUDataFormat::R16G16B16A16_FLOAT;
    ...
    uint32_t unmapBindType(uint32_t bind_flags) {
        ...
        if (bind_flags & D3D11_BIND_INDEX_BUFFER) {
            res_type |= GPUResource::RES_INDEX_BUFFER;
        }
        if (bind_flags & D3D11_BIND_CONSTANT_BUFFER) {
            res_type |= GPUResource::RES_CONSTANT_BUFFER;
        }
        if (bind_flags & D3D11_BIND_DEPTH_STENCIL) {
            res_type |= GPUResource::RES_DEPTH_STENCIL;
        }
        if (bind_flags & D3D11_BIND_RENDER_TARGET) {
            res_type |= GPUResource::RES_RENDER_TARGET;
        }
        if (bind_flags & D3D11_BIND_SHADER_RESOURCE) {
            res_type |= GPUResource::RES_SHADER_RES;
        }
        return res_type;
    }
