...
#ifndef UKIVE_WINDOW_WIN_FRAME_NATIVE_NON_CLIENT_FRAME_H_
#define UKIVE_WINDOW_WIN_FRAME_NATIVE_NON_CLIENT_FRAME_H_
...
namespace win {
    ...
    public:
        ...
        LRESULT onGetMinMaxInfo(WPARAM wParam, LPARAM lParam, bool* handled) override { return 0; }
